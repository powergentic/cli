---
title: Configuration
description: Complete configuration reference for Powergentic CLI — JSON and YAML formats, LLM profiles, local overrides, tool safety, and auto-select rules.
---

# :octicons-gear-24: Configuration Reference
...
See [Commands](../commands/index.md) for full details.
