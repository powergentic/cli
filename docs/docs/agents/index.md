---
title: Agent System
description: Define custom AI behaviors with AGENTS.md and agent files — project-wide instructions, named agents, scoped agents, and tool filtering.
---

# :material-robot: Agent System
...
- :white_check_mark: `AGENTS.md` — applies (global)
- :white_check_mark: `.powergentic/agents/general-assistant.agent.md` — applies (root-level)
- :white_check_mark: `frontend/agents/react-expert.agent.md` — applies (scope matches)
- :x: `backend/agents/dotnet-expert.agent.md` — does NOT apply (different scope)
- :x: `infrastructure/agents/terraform-expert.agent.md` — does NOT apply (different scope)
...
See [Tools](../tools/index.md) for full details on each tool.
