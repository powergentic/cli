...
description: Get up and running with Powergentic CLI in minutes. Initialize your configuration, add an LLM profile, and start your first AI-powered chat session.
---

# :octicons-rocket-24: Getting Started
...
!!! info
    See [LLM Providers](../llm-providers/index.md) for detailed setup instructions for each provider.
...
!!! tip
    Learn more about creating custom agents in the [Agents](../agents/index.md) documentation.
...
- [Agents](../agents/index.md) — Creating custom agents for your project
- [Configuration](../configuration/index.md) — Advanced configuration options
- [Tools](../tools/index.md) — Understanding the tools available to the agent
