---
title: Commands
description: Full reference for every Powergentic CLI command and option — chat, explain, suggest, config, and init.
---

# :octicons-terminal-24: Commands Reference
...
5. Enters a interactice chat loop: your input → LLM → tool calls (if any) → response
