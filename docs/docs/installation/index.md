---
title: Installation
description: Install Powergentic CLI from source, publish a self-contained binary, and get it running on macOS, Linux, or Windows.
---
...
!!! note
    Arguments after `--` are passed to the PGA CLI; arguments before `--` are consumed by `dotnet run`.
...
- [Getting Started](../getting-started/index.md) — First-time setup and your first chat
- [Configuration](../configuration/index.md) — Setting up LLM providers
