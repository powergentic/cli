...
description: Complete reference for all 9 built-in tools available to the Powergentic CLI AI agent — file I/O, shell execution, git operations, search, and more.
---

# :material-wrench: Built-in Tools
...
!!! tip
    See [Configuration — Tool Safety](../configuration/index.md#tool-safety) to configure approval behavior.
