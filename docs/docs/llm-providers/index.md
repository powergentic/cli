---
title: LLM Providers
description: Configure Azure OpenAI, Azure AI Foundry, and Ollama as LLM backends for Powergentic CLI — setup guides, authentication, and troubleshooting.
---

# :material-cloud-cog: LLM Providers
